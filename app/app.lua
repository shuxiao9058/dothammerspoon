...
local appSettings = {
    ...
    --     lang = 'English'
    -- },
    { key = nil, bundleID = "org.mozilla.firefox", lang = "English", launchFunc = nil, maximize = true },
    {
        key = nil,
    ...
    { key = ni,  bundleID = "com.microsoft.VSCode", lang = "English", launchFunc = nil, maximize = true },
    { key = "s", bundleID = "com.stack-beta.io",    lang = "English", launchFunc = nil, maximize = true }, --  {
    --     key = nil,
    ...
    -- },
    {
        ...
        lang = "Chinese"
    }, { key = nil, bundleID = "com.tencent.WeWorkMac", lang = "Chinese" }, -- com.tencent.WeWorkMac
    { key = "d", bundleID = "org.zealdocs.zeal",     lang = "English" },
    { key = nil, bundleID = "ru.keepcoder.Telegram", lang = "Chinese", maximize = true },
    { key = nil, bundleID = "com.apple.Safari",      lang = "English", maximize = true }, {
    key = nil,
    bundleID = "com.devon-technologies.think3",
    lang = "Chinese"
    -- maximize = true
}, { key = nil, bundleID = "com.sublimetext.3", lang = "English", maximize = true }
}
...
local function showAppKeystroke()
    if showAppKeystrokeAlertId == "" then
        ...
        showAppKeystrokeAlertId = hs.alert.show(keystroke, hs.alert.defaultStyle,
...
function M:toggleMaximized(win, startup, force)
    ...
    if startup then
        ...
        if win:isMinimized() then win = win:unminimize() end
...
toggleApp = function(app)
    ...
    if launchFunc == nil then
        launchFunc = function() hs.application.launchOrFocusByBundleID(appBundleID) end
    end
    ...
    if currentApp ~= nil and currentApp:bundleID() == appBundleID then
        ...
        if #wins > 0 then
            for k, win in pairs(wins) do if win:isMinimized() then win:unminimize() end end
        else
            currentApp:activate()
        end
...
function M:start()
    ...
    -- Window Hints
    hyperfns["f"] = hs.hints.windowHints
